...
from M_Y_S.web_driver import WebDriverSetup


BETIKA_URL = "https://www.betika.com/en-ke/login?next=%2F"
...
class BetClient(object):
    ...
    def sign_in(self):
        ...
        """
        self.web_setup.open_session(BETIKA_URL)
        self.driver.find_element_by_css_selector("input[type=text]").send_keys(self._username)
        self.driver.find_element_by_css_selector("input[type=password]").send_keys(self._password)
        #self.driver.find_element_by_name("frmForceTerms").click()
        self.driver.find_element_by_name("session__form__button__container").click()
